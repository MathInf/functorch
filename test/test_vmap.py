...
class TestVmapOperatorsOpInfo(TestCase):
    ...
    def test_vmap_exhaustive(self, device, dtype, op):
        ...
        for sample_input in sample_inputs_itr:
            ...
            try:
                for loop_out, batched_out in get_fallback_and_vmap_exhaustive(op.op, arg_values, kwarg_values, op_info=op):
                ...
                for a_op in op.aliases:
                    for loop_out, batched_out in get_fallback_and_vmap_exhaustive(a_op, arg_values, kwarg_values, op_info=op):
                        self.assertEqual(loop_out, batched_out, atol=1e-4, rtol=1e-4)
